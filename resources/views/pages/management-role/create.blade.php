...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('management-role.store') }}" method="POST" class="space-y-4">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="text" name="display_name" class="border rounded w-full p-2" value="{{ old('display_name') }}" required>
